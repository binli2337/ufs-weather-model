...
if [[ $MACHINE_ID = wcoss2 ]]; then
  ...
  DISKNM=/scratch1/NCEPDEV/stmp4/Bin.Li/hafs
  STMP=$dprefix/stmp4
  PTMP=$dprefix/stmp2
...
HAFS_MOM6_INPUTDATA_ROOT=/scratch1/NCEPDEV/stmp4/Bin.Li/hafs/NEMSfv3gfs/input-data-20221101
...
[
  ...
  <!ENTITY HAFS_MOM6_INPUTDATA_ROOT "${HAFS_MOM6_INPUTDATA_ROOT}">
...
EOF
    ...
    (
      ...
      export HAFS_MOM6_INPUTDATA_ROOT=${HAFS_MOM6_INPUTDATA_ROOT}
